    ...
    <aside className='border-r-2 border-blue-200 p-4 text-sm bg-blue-100 w-64 h-screen text-black'>
      {selectedNode ? (
        ...
        <>
          ...
          <div
            className='bg-white p-3 border-2 border-black-500 rounded cursor-move flex justify-center items-center text-black-500 hover:bg-black-50 transition-colors duration-200'
